    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v2/admin/summary").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v2/monthly-orders-revenue").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "api/v2/update-order-status/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v2/all-orders").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.PUT, "api/v2/users/status").hasRole("ADMIN")
