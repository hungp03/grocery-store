...
const AddProduct = () => {
    ...
    const handleCreateProduct = async (data) => {
        ...
        try {
            const response = await apiCreateProduct(productToCreate, productImage, "product");
        ...
        <div className='w-full'>
            ...
            <div className="flex justify-center items-center min-h-screen">
                <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-xl">
                    <form onSubmit={handleSubmit(handleCreateProduct)} className="space-y-6"> {/* Changed from space-y-4 to space-y-6 */}
                        <div className="mb-6"> {/* Changed to mb-6 */}
                            <InputFormAdmin
